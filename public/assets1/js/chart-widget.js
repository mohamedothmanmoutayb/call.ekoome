...
// column chart
  var optionscolumnchart = {
    ...
    fill: {
      colors: [TivoAdminConfig.primary, TivoAdminConfig.secondary, "#51bb25"],
      type: "gradient",
      gradient: {
        shade: "light",
        type: "vertical",
...
// browser-candlestick chart
  var optionscandlestickchart = {
    ...
    plotOptions: {
      candlestick: {
        colors: {
          upward: TivoAdminConfig.primary,
          downward: TivoAdminConfig.secondary,
        },
      },
    },
    fill: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "20%",
        colors: {
          backgroundBarColors: [TivoAdminConfig.primary],
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [TivoAdminConfig.primary],
      },
    },
    series: [
      {
