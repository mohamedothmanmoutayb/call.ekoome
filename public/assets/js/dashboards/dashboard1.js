document.addEventListener("DOMContentLoaded", function () {
  ...
  var chart = {
    series: [
      {
        name: "Expensse",
        data: [50, 60, 30, 55, 75, 60, 100, 120, 90, 100, 120],
      },

      {
        name: "Free Ads",
        data: [35, 45, 40, 50, 35, 55, 40, 45, 30, 45, 40],
      },
      {
        name: "Revenue",
        data: [100, 75, 80, 40, 20, 40, 0, 25, 15, 20, 25],
      },
    ],
    chart: {
      toolbar: {
    ...
    xaxis: {
      ...
      categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Oct", "Nov", "Dec"],
    },
    markers: {
      strokeColor: [
        "var(--bs-danger)",
