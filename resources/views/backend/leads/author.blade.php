                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @if (!empty($lead->n_lead))
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="form-group mb-2 text-center">
                                                <button class="btn btn-primary btn-rounded my-2 " data-bs-toggle="modal"
                                                    data-bs-target="#add-new-lead">Create New Order</button>
                                                <button class="btn btn-primary btn-rounded my-2 addreclamationgetid"
                                                    data-id="{{ $lead->id }}" id=""
                                                    title="Complaint">Complaint</button>
                                                <a class="btn btn-primary btn-rounded my-2"
                                                    href="{{ route('leads.refresh', $lead->id) }}">Refresh Data</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="card" style="box-shadow: 0px 0px 8px 3px;">
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="card-title"style="font-size: 25px;">
                                                        <i class="mdi mdi-menu font-50"
                                                            style="margin-right: 30px;"></i>Detail Product - <span>N
                                                            Command : {{ $lead->n_lead }}</span><span>Status Confirmation :
                                                            <span
                                                                @if ($lead->status_confirmation == 'call later') style='color:#fb8c00' @endif>{{ $lead->status_confirmation }}</span></span>
                                                    </h4>
                                                        ...
                                                        <div class="row col-12">
                                                            <div class="form-group col-lg-6 col-md-12">
                                                                ...
                                                                <select class="form-control" name="product"
                                                                    id="first_product" style="width: 100%;height: 36px;">
                                                                    <option value="">Select Product</option>
                                                            ...
                                                            <div class="form-group m-r-2  col-lg-3 col-md-12">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="lead_quantity" name="quantity"
                                                                    @if ($lead->quantity != null) value="{{ $lead['leadpro']->quantity }}" @else value="1" @endif />
                                                            </div>
                                                            <div class="form-group m-r-2  col-lg-3 col-md-12">
                                                                <label>Product Price :</label>
                                                                <input type="number" class="form-control"
                                                                    id="lead_values" name="price"
                                                                    value="{{ $lead['leadpro']->lead_value }}" />
                                                            </div>
                                                        </div>
                                                        <div class="row col-12">
                                                            <div class="form-group m-r-2  col-lg-3 col-md-12">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    @if ($lead->quantity != null) value="{{ $lead->quantity }}" @else value="1" @endif />
                                                            </div>
                                                            <div class="form-group m-r-2  col-lg-3 col-md-12">
                                                                <label>Total Price :</label>
                                                                <input type="text" class="form-control"
                                                                    id="total_lead_values" name="price"
                                                                    value="{{ $lead->lead_value }}" disabled />
                                                            </div>
                                                            <div class="form-group m-r-2  col-lg-3 col-md-12">
                                                                <a class="btn btn-primary btn-rounded m-t-20 mb-2 text-white"
                                                                    data-id="{{ $lead->id }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 align-self-center">
                                                                <div class="form-group mb-0 text-center">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-primary btn-rounded m-t-10 mb-2 testupsell"
                                        ...
                                        <div class="row">
                                            <div class="col-12 align-self-center">
                                                <div class="form-group mb-0 text-center">
                                                    ...
                                                    <a class="btn btn-success btn-rounded m-t-10 mb-2" _blank
                                                        href="{{ route('relancements.index', $lead->id) }}">Relancement</a>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-rounded m-t-10 mb-2 "
                                                        data-id="{{ $lead->id }}" id="cancels">CANCEL</button>
                                    ...
                                    <div id="searchdetail" class="modal fade in" tabindex="-1" role="dialog"
                                        aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <from class="form-horizontal form-material">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit"
                                                            class="btn btn-primary waves-effect editlead"
                                    ...
                                    <div id="add-new-lead" class="modal fade in" tabindex="-1" role="dialog"
                                        aria-labelledby="myModalLabel" aria-hidden="true">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 col-sm-12 m-b-20">
                                                                    <select class="form-control custom-select"
                                                                        style="width: 100%; height:36px;" id="id_product">
                                                                        <option>Select Product</option>
                                                                        @foreach ($proo as $v_product)
                                                                            <option value="{{ $v_product->id }}">
                                                                                {{ $v_product->name }} /
                                                                                {{ $v_product->price }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-4 col-sm-12 m-b-20">
                                                                    <input type="hidden" class="form-control"
                                                                        id="lead_id" placeholder="Name Customer">
                                                                    <input type="text" class="form-control"
                                                                        id="name_customer" placeholder="Name Customer">
                                                                </div>
                                                                <div class="col-md-4 col-sm-12 m-b-20">
                                                                    <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-md-4 col-sm-12 m-b-20">
                                                                    <input type="text" class="form-control"
                                                                        id="mobile2" placeholder="Mobile 2">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 col-sm-12 m-b-20">
                                                                    <input type="numbre" class="form-control"
                                                                        id="total" placeholder="Total Price">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form class="form pt-3">
                                                    <div class="row col-12">
                                                        ...
                                                        <div class="form-group m-r-2 col-lg-3 col-md-12">
                                                            <label>Quantity :</label>
                                                            <input type="text" class="form-control" id="lead_quantits"
                                                                name="lead_quantits" value="" />
                                                        </div>
                                                        <div class="form-group m-r-2 col-lg-3 col-md-12">
                                                            <label>Total Price :</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 align-self-center">
                                                            <div class="form-group mb-0 text-center">
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn-primary btn-rounded m-t-10 mb-2 testupsells">Add
                                                                    Upsell</button>
                                                                <button type="button"
                                                                    class="btn btn-primary btn-rounded m-t-10 mb-2 infoupsell">Information
                                                                    Upsell</button>
                                                                <button type="button"
                                                                    class="btn btn-primary btn-rounded m-t-10 mb-2 upselllist">Upsell
                                                                    List</button>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        $(document).ready(function() {
            ...
            $(function(e) {
                $('#savelead').click(function(e) {
                    ...
                    if ($('#id_product').val() != " " && $('#quantity').val() != "" && $('#total')
                        .val() != "" && n >= 10 && $('#address').val() != "") {
            ...
            $('body').on('click', '.detaillead', function(products) {
                ...
                $.get("{{ route('leads.index') }}" + '/' + id + '/details', function(data) {
                    ...
                    for (var i in data) {
                        ...
                        $('#listupsells').html("<tr><td>" + data[i].product[i].name + "</td><td>" +
                            data[i].quantity + "</td><td>" + data[i].lead_value + "</td></tr>");
                    }
                });
            });
        });
        ...
        $(document).on('click', '.next', function() {
            ...
            $.get("{{ route('leads.index') }}" + '/' + id + '/details', function(data) {
                ...
                for (var i in data) {
                    ...
                    var price = data[0].leads[0].lead_value;
                    $('#addr' + i).html("<td>" + (i + 1) +
                        "</td><td><div class='form-control-wrap'><select class='form-control form-select select2-accessible' data-placeholder='sélectionnez une option' required='' id='product_lead' name='id_product[]' data-select2-id='fv-topics' tabindex='-1' aria-hidden='true'>@foreach ($productss as $v_product) @foreach ($v_product['products'] as $product)<option value='{{ $product['id'] }}' {{ $product['id'] == '"+ data[i].id_product +"' ? 'selected' : '' }}>{{ $product['name'] }}</option>@endforeach @endforeach</select></div> </td><td><input  name='quantity[]' id='quantity_lead' type='text' placeholder='Quantity' value='" +
                        quantity +
                        "' required class='form-control input-md'></td><td><input  name='price[]' id='total_lead' type='text' placeholder='Lead Value' value='" +
                        price + "' required class='form-control input-md'></td>");
