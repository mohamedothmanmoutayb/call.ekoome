                                    ...
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="form-group mb-2 text-center">
                                                ...
                                                <button class="btn btn-primary btn-rounded m-b-10 addreclamationgetid"
                                                    data-id="{{ $lead->id }}" id=""
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-12">
                                                            <a class="btn btn-success waves-effect" id="sapp"
                                        ...
                                        <div class="col-12 align-self-center">
                                            <div class="form-group mb-0 text-center">
                                                ...
                                                <button type="button" class="btn btn-orange btn-rounded m-t-10 mb-2 "
                                                    data-id="{{ $lead->id }}" id="unrechs">no answer</button>
